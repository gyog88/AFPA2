...
<body>
  ...
  <div class="container">
    ...
    <!--menu du haut-->
    <div class="row p-0 m-0 float-left w-100">
        ...
        <nav class="navbar navbar-expand-lg navbar-light float-left w-100 align-items-center align-items-sm-center">
          ...
          <div class="collapse navbar-collapse" id="menuhaut">
            <div class="d-flex d-sm-flex justify-content-between justify-content-sm-between w-100">
              <ul class="navbar-nav">
                <li class="nav-item">
                  <a class="nav-link" href="index.php" <?php if(basename($_SERVER['PHP_SELF'])=="index.php") echo "active"; ?> >Accueil</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="tableau.php" <?php if(basename($_SERVER['PHP_SELF'])=="tableau.php") echo "active"; ?>>Tableau</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="contact.php" <?php if(basename($_SERVER['PHP_SELF'])=="contact.php") echo "active"; ?>>Contact</a>
                </li>
              </ul>
<a href="add.php" <?php if(basename($_SERVER['PHP_SELF'])=="add.php") echo "active"; ?> >Ajouter Produit</a>
              ...
              <form action="#" class="form-inline" method="POST" id="form_search_promo">
                ...
                justify-content-end justify-content-sm-end">
                  <input type="search" class="input-sm m-1 m-sm-1 m-lg-0 mr-lg-1" name="rechercher" id="rechercher"
                    placeholder="Search" />
                  <button type="submit"
                    class="btn btn-outline-success btn-sm m-1 m-sm-1 ml-auto ml-sm-auto m-lg-0 mr-lg-1">
                    Rechercher
                  </button>
                </div>
                <!-- fin de form-group-->
    ...
    <div class="row">
      <div class="col-12 col-sm-12">
        <img class="img-fluid w-100" src="./jarditou_css/src/img/promotion.jpg" alt="promotion sur lames de terrasses" />
      </div>
      <!--fin de col-->
    </div>
