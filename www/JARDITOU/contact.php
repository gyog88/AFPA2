    ...
    <div class="col-12 col-sm-12 p-3 p-sm-3 mb-3 mb-sm-3 shadow">
        <section>
            ...
            <article class="w-100 w-sm-100">
                ...
                <!--Début du Formulaire---------------------------------------->
                <form method="POST" onsubmit="checkForm()" action="http://bienvu.net/script.php"
                    id="formulaire_contact1" name="formulaire_contact1" class="form-block">
                    <div class="form-group ">
                        ...
                        <fieldset>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <button type="submit" class="btn btn-dark btn-lg btn-sm" id="envoyer"
